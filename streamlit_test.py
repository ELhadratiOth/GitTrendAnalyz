...
# def supprimer_doublons(list):
#     nouvelles_occurrences = []
#     for sous_liste in list:
#         if sous_liste not in nouvelles_occurrences:
#             nouvelles_occurrences.append(sous_liste)
#     return nouvelles_occurrences
# list =  supprimer_doublons(list)
...
# https://github.com/search?q=created%3A>2024-02-13+&sort=stars&order=desc&type=repositories
# https://api.github.com/search/repositories?q=created:>2024-02-13&sort=stars&order=desc
